...
@property (nonatomic, unsafe_unretained) id<ZXCaptureDelegate> delegate;
@property (nonatomic, copy) NSString *captureToFilename;
@property (nonatomic) CGAffineTransform transform;
@property (unsafe_unretained, nonatomic, readonly) ZXCaptureVideoOutput *output;
@property (unsafe_unretained, nonatomic, readonly) CALayer *layer;
